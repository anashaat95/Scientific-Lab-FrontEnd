...
const ConvertUserToUpdateUserForm = (user: IUser): IUpdateUserFormInput => {
  return {
    ...
    google_scholar_url: user.google_scholar_url ?? null,
    academia_url: user.academia_url ?? null,
    scopus_url: user.scopus_url ?? null,
    researcher_gate_url: user.researcher_gate_url ?? null,
